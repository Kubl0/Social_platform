    ...
    return (
        ...
        <div className="bg-violet-100 rounded-l-3xl pb-2 w-[90%] ml-10">
            <div className="flex flex-col mt-[45%] overflow-y-auto h-[50%]">
                <div className="pt-2 pb-2 bg-violet-100 rounded-3xl mb-3">
                    <h2 className="text-xl font-bold uppercase text-center">Friend list</h2>
                </div>
                {friendList.length > 0 ? (
                    <div className="pl-[5%]">
                            ...
                            >
                                <div className="flex">
                                    <div className="mb flex flex-row mb-5">
                                        ...
                                        } alt="profile picture" className="rounded-full mr-3"
                                               width={40}
                                               height={40}
                                        />
